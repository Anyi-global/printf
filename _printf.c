...
/**
 * _printf - a function that prints formatted output to the std output
 * @format: a sting that tells the printf how to format the output
 ...
 * @buffer: temporary memory area that holds formatted characters
