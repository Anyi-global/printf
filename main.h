...
/**
 * struct fmt - Structure of format
 *
 * @fmt: The format.
 * @fn: The function pointer associated with it
 */
struct fmt
{
	char fmt;
...
/**
 * typedef struct fmt fmt_t - Alias name of the format structure
 *
 * @fmt: The format.
 * @fm_t: The alias name of the format structure
 */
